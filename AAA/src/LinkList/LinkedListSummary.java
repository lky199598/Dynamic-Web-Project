...
public class LinkedListSummary {	
	public static void main(String[] args) {
		...
		createHeadLinked(head);
		output(head);
		
		head.next = null;
		createTailLinked(head);
		output(head);
	...
	//头插法
	public static void createHeadLinked(Node head)
	{
		Scanner in=new Scanner(System.in);
				
		System.out.println("头插法    输入数字，0结束");
		int n = in.nextInt();
	...
	//尾插法
	public static void createTailLinked(Node head)
	{
		Scanner in=new Scanner(System.in);
		Node p = head;
