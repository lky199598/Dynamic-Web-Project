...
public class HashTableClass {
	public static void put(Hashtable<Students, Integer> goods)
	{
	...
	public static void query1(Hashtable<Students, Integer> goods)
	{	
	...
	public static void query2(Hashtable<Students, Integer> goods)
	{	
	...
	public static void query3(Hashtable<Students, Integer> goods)
	{	
	...
	public static void query4(Hashtable<Students, Integer> goods)
	{	
	...
	{	
	Hashtable<Students, Integer> goods = new Hashtable<Students, Integer>();
	put(goods);
	query1(goods);
	query2(goods);
	query3(goods);
