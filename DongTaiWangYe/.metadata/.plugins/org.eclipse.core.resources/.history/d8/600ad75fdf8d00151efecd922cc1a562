...
<script type="text/javascript">
	function  AddIntoCart(id) {
	    ...
	    J.dialog.get({id: 'haoyue_creat',title: '购物成功',width: 600,height:400, link: '<%=path%>/Servlet/CartServlet?id='+id+'&number='+num+'&action=AddInCart', cover:true});
	}
...
<body>
 ...
 %>
					<div>
						<dl>
							<dt>
								<a href="show_details.jsp?id=<%=items.getId()%>"><img
									src="images/<%=items.getPicture()%>" width="120" height="90"
									border="1" /></a>
							</dt>
