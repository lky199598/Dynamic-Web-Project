...
#wrapper{
    ...
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #6A5ACD),color-stop(1, #2F368F)); 
}
#header{
	height:100px;
	width:100%;
...
<div> 标签可以把文档分割为独立的、不同的部分。它可以用作严格的组织工具，并且不使用任何格式与其关联。
 ...
 <div id="wrapper">
	<div id="header">
		<div id="logo"></div>
		<div id="heading">
			<div id="title">欢&nbsp;乐&nbsp;校&nbsp;园&nbsp;购</div>
			<div id="subTitle">最新版</div>
		</div>
	</div>
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<!-- start of login form -->
					<div id="welcome">
						<span id="welcome-text">欢&nbsp;迎&nbsp;登&nbsp;录</span>
					</div>
					<div id="user-name">
				 ...
				 <div id="button-group">
					 <input type="radio" name="identity" value="用户" class="btn" checked="checked"/>
					 <font size="5"><b>用户</b></font>
					 
                     <input type="radio" name="identity" value="管理员" class="btn"/>
                     <font size="5"><b>管理员</b>
				 </div>
