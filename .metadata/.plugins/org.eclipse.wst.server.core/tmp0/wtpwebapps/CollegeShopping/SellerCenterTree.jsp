...
var treeMenu = [
	{ level:1, name:"我的订单"},
	{ level:2, name:"未付款", ico:"images/icon_default.gif",link:"students/queryAllStudents.action"},
	{ level:2, name:"交易中",ico:"images/icon_default.gif",link:"role_list.html"},
	{ level:2, name:"交易完成",ico:"images/icon_default.gif",link:"role_list.html"},
	
	{ level:1, name:"我的消息",ico:"images/icon_default.gif",link:"complaint_list.html"},

	{ level:1, name:"物品审核状态"},
	{ level:2, name:"火热售卖", ico:"images/icon_default.gif",link:"role_list.html"},
	{ level:2, name:"等待审核", ico:"images/icon_default.gif",link:"role_list.html"},
	{ level:2, name:"未过审核", ico:"images/icon_default.gif",link:"role_list.html"},
	
	{ level:1, name:"物品信息修改", ico:"images/icon_default.gif",link:"complaint_list.html"},
	
	{ level:1, name:"物品上传", ico:"images/icon_default.gif",link:"complaint_list.html"},

	{ level:1, name:"物品下架", ico:"images/icon_default.gif",link:"complaint_list.html"}
];
</script>
<style>
* {
