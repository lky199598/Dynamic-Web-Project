...
var treeMenu = [
	...
	{ level:2, name:"交易中", ico:"images/icon_default.gif",link:"students/queryAllStudents.action"},
	{ level:2, name:"交易完成", ico:"images/icon_default.gif",link:"students/queryAllStudents.action"},
	
	{ level:1, name:"我的购物车",ico:"images/icon_default.gif",link:"complaint_list.html"},
		
	{ level:1, name:"信息管理",ico:"images/icon_default.gif",link:"complaint_list.html"}
];
</script>
<style>
* {
