			...
			<div class="jdm-toolbar J-toolbar">                    
				...
				<div class="jdm-toolbar-tabs J-tab">                         
					<div data-type="bar" class="J-trigger jdm-toolbar-tab jdm-tbar-tab-cart">                                
						<i class="tab-ico"></i>                                <em class="tab-text">购物车                                
						</em>                                                  
					</div>                          
					<div data-type="bar" clstag="h|keycount|cebianlan_h_follow|btn" class="J-trigger jdm-toolbar-tab jdm-tbar-tab-follow" data-name="follow" data-login="true">                                
						<i class="tab-ico"></i>                                <em class="tab-text">                                    我的关注                                
						</em>                                                 
					</div>                          
				...
				<div data-type="bar" clstag="h|keycount|cebianlan_h_jimi|btn" class="J-trigger jdm-toolbar-tab jdm-tbar-tab-jimi" data-name="jimi" data-login="true" data-iframe="//jimi.jd.com/index.action?source=jdhome">                                
					<i class="tab-ico"></i>                                
		...
		<div class="focus">
			...
			<div id="lunbo">
				<ul id="one">
					...
					<li><a href=""><img src="./images/56a05078N6add136b.jpg"></a></li>
					<li><a href=""><img src="./images/56a09e6aN373313d9.jpg"></a></li>
				</ul>
				<ul id="two">
					<li class="on">1</li>
					<li>2</li>
		...
		<div id="guessyou" class="">
			...
			<div class="list1">
				...
				<ul>        
					...
					<li class="fore5">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="小米（MI）小米蓝牙耳机-黑色 " src="images/55d17800N1b88605f.jpg" class=""></a>
						</div>                
						<div class="p-info">                
							<div class="p-name">
					...
					<li class="fore6">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="SSC汽车高压洗车机高压清洗机家用220v洗车器洗车泵1616d" src="images/568cbdcbNac6d0772.jpg" class=""></a>
						</div>                
						<div class="p-info">                
							<div class="p-name">
		...
		<div class="home-special-buy-v4 w">	
			...
			<div class="hs-content" style="position: relative;">		        
				<div class="has-col1">		            
					...
					<a clstag="h|keycount|2015|13w" id="jd_chaojidapai" style="position: absolute; right: 172px; top: 0; display: block; overflow: hidden; width: 403px; height: 405px;" target="_blank" href="#"><img src="images/56cfb194N1f7db68f.jpg">
					</a>
		...
		<div class="main main-selected" style="display: block;">
			<div class="main-inner">
				...
				<ul class="main-extra">
					...
					<li class="fore3">
						<!-- 广告位 2_955_6821-->
						<div id="ad6821"><a href="#"><img src="images/56cfca73N8fa61e5a.jpg" width="219" height="316"></a></div>
					</li>
				</ul>
			</div>
			<div class="slider">
	...
	<div class="slider-body" style="position: relative;">
		<ul class="slider-main1" style="width: 2634px; left: -439px; position: absolute;">
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="images/56cdc44dN5d0f942d.jpg" width="439" height="315" data-lazy-img="done" alt=""></a>
			</li>
			...
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="images/56cdc3e5N16ad9ec8.jpg" width="439" height="315" data-lazy-img="done" alt=""></a>
			</li>
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="images/56cdc416Ne54f9cd9.jpg" width="439" height="315" alt=""></a>
			</li>
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#" target="_blank" title=""><img src="images/56cdc44dN5d0f942d.jpg" width="439" height="315" alt=""></a></li>
		<li class="slider-panel" style="float: left; display: list-item;">
			<a href="#"><img src="images/56cdc3c0N2d556f4f.jpg" width="439" height="315" alt=""></a>
		</li>
	</ul>
...
<div class="ss" id="share">
 ...
 <div class="mc">
	<div class="sw" style="position: relative;">
		<ul style="top: -720px; position: absolute;"><li clstag="h|keycount|2015|31b5" data-switchable-clone="1" style="display: list-item;">
			<div class="p-img">
		...
		<li style="display: list-item;" class="">
			<div class="p-img">
				<a href="#" target="_blank"><img src="images/56c2dd74N1bd18e2b.jpg" alt="台灯买来女儿很开心她说非常好用，京东值得肯定！" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
