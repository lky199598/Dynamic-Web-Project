...
<html>
  ...
  <body>
	<h2>&nbsp; 文件上传	</h2>
<!-- 	表单标签中设置enctype="multipart/form-data"
                来确保匿名上载文件的正确编码
        enctype就是encodetype翻译成中文就是编码类型的意思！
...
-->
    ...
    <p class="thumbs">
    	<a href="images/img2-thumb.jpg" title="Image2"><img src="images/img2-thumb.jpg"></a>
    	<a href="images/img3-thumb.jpg" title="Image3"><img src="images/img3-thumb.jpg"></a>
