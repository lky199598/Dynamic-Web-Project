...
public class create_houseAction extends ActionSupport{
	...
	public String create_house(){
		...
		dao.House_insert(loc_province+loc_city+loc_town, 0, Double.parseDouble(dayprice), Double.parseDouble(housearea), surrounding, othermessage, str, title_textfield, session.get("current_id").toString());
