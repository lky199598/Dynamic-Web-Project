...
<form action="index.html" name="login" method="post">
          ...
          <tr colspan=2><td>登陆类型:
          <input type="radio" name="shenfen" value="admin" checked>学生
          <input type="radio" name="shenfen " value="users" checked>教师
          <input type="radio" name="shenfen " value="users" checked>管理员
          </td></tr>
          </table>
	      </p>
	      <h2 class="style6">没有账号？<a href="register.jsp">点此注册</a></h2>
</form>
<br><br>
