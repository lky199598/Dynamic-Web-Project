...
<body>
	<center>
	   <h1>教师信息查询</h1>
		...
		你要查询的老师有 <font size="5" color="black"> <%=RowCount%>
		</font>人 <br>
		<br>
	...
	<%
		...
		{
	%>
	<a href="lookTeacher.jsp?Page=<%=Page-1%>">上一页</a>&nbsp;
	<%
		}
	%>
	<%
		...
		{
	%>
	<a href="lookTeacher.jsp?Page=<%=i%>"><%=i%></a>&nbsp;
	<%
		i++;
		}
	%>
	...
	<%
		...
		{
	%>
	<a href="lookTeacher.jsp?Page=<%=Page+1%>">下一页</a>
	<%
		}
	%>
</center>
